...
os.environ['url'] = 'https://test.yieldwerx.com/'
url1 = "https://test.yieldwerx.com/"
...
def _run_feature(feature, tags=None, userdata=None):
    ...
    cmd = "behave -f allure_behave.formatter:AllureFormatter -o allure/results {}".format(feature) + " -D url="+str(url1)
...
def main():
    ...
    # cmd = 'behave -D url=https://beta.speedhome.com/'
    # r = call(cmd, shell=True)
    if args.tags:
